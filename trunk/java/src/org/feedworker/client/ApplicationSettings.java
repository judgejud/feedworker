...
public class ApplicationSettings {
	...
	private ApplicationSettings() {
		...
		try {
			if (SETTINGS_FILE.exists()) {
				...
				enableCustomDestinationFolder(Boolean
	...
	public void writeApplicationFirstTimeUsedFalse() {
		...
		try {
			properties.setProperty(propertyEncrypter
					.encrypt("IS_APPLICATION_FIRST_TIME_USED"), valueEncrypter
					.encrypt(Boolean.toString(isApplicationFirstTimeUsed)));
			storeSettings();
		} catch (GeneralSecurityException e) {
			error.launch(e, getClass());
		} catch (IOException e) {
	...
	private void loadDefaultSettings() {
		...
		try {
			...
			properties.setProperty(propertyEncrypter.encrypt("FIRSTRUN"),
					valueEncrypter.encrypt(Boolean
							.toString(isApplicationFirstTimeUsed)));
