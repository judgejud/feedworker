...
public class EnhancedSystemTray {
	...
	private EnhancedSystemTray(Window owner, Mediator proxy) {
		this.owner = owner;
	...
	public static EnhancedSystemTray getInstance(Window owner, Mediator proxy) {
		if (systemTray == null) {
			if (SystemTray.isSupported()) {
				systemTray = new EnhancedSystemTray(owner, proxy);
			}
		}
