 ...
 * @author luca
 */
class paneItasa extends paneAbstract{
    ...
    void initButtons() {
        ...
        jbCopySub.setToolTipText("copia il sub per la regola destinazione avanzata");
        ...
        jpButton.add(jbAllItasa, gbc);
        gbc.gridx = 1;
        jpButton.add(jbDown, gbc);
        gbc.gridx = 2;
        jpButton.add(jbClean, gbc);
        gbc.gridx = 3;
        jpButton.add(jbAllMyItasa, gbc);
        gbc.gridx = 4;
        jpButton.add(jbCopySub, gbc);
...
/*
    private void jbCopySubMouseClicked(){
        proxy.copyTitleFeed(jtItasa, jtMyItasa);
    }
*/
