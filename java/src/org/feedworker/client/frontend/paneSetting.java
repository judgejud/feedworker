...
public class paneSetting extends JPanel {
	...
	private void initPanelSettingsGlobal() {
		...
		DefaultComboBoxModel dcbmL = new DefaultComboBoxModel(new String[] {
				"standard", "blackmoon", "blackstar", "blueice", "bluesteel",
				"greendream", "silvermoon" });
		...
		gbc.gridx = 2;
		DefaultComboBoxModel dcbmF = new DefaultComboBoxModel(
				Awt.getAvailableFont());
	...
	private void saveSettings() {
		proxy.saveSettings(jrbDirLocal.isSelected(), jtfDestSub.getText(),
				...
				new String(jpfSamba.getPassword()), jcbMinuti.getSelectedItem()
						.toString(), jcbLookFeel.getSelectedItem().toString(),
				jcbAudio.isSelected(), jcbTimeout.getSelectedItem().toString(),
				jcbAdvancedDest.isSelected(), jtfRssItasa.getText(),
				jtfRssMyItasa.getText(), jtfItasaUser.getText(), new String(
						jpfItasa.getPassword()), jrbDownAuto.isSelected(),
