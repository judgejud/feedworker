 ...
 * @author luca
 */
public class SettingsJP extends JPanel {
    ...
    private static SettingsJP jpanel = null;
    ...
    public static SettingsJP getPanel() {
        if (jpanel == null) {
            jpanel = new SettingsJP();
        }
        return jpanel;
    }
    ...
    private void initTree() {
        ...
        jtSettings.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
    ...
    private void initPanelSettingsGlobal() {
        ...
        gbc.gridx = 2;
        DefaultComboBoxModel dcbmL = new DefaultComboBoxModel(
                new String[]{"Synthetica Standard", "Synthetica BlackEye", "Synthetica BlackMoon", "Synthetica BlackStar", "Synthetica BlueIce",
                		     "Synthetica BlueMoon", "Synthetica BlueSteel", "Synthetica GreenDream", "Synthetica MaouveMetallic", "Synthetica OrangeMetallic",
                		     "Synthetica SilverMoon", "Synthetica Simple2D", "Synthetica SkyMetallic", "Synthetica WhiteVision"});
        ...
        gbc.gridx = 2;
        gbc.gridwidth = 1;
        DefaultComboBoxModel dcbmT = new DefaultComboBoxModel(
                new String[]{"3", "6", "9", "12", "15", "18"});
        ...
        gbc.gridx = 2;
        DefaultComboBoxModel dcbmF = new DefaultComboBoxModel(Awt.getAvailableFont());
    ...
    private void initPanelSettingsSubsf() {
        ...
        JLabel jlRss = new JLabel("Indirizzo RSS: ");
        jlRss.setForeground(Color.red);
        gbc.anchor = GridBagConstraints.NORTHWEST;
        gbc.gridx = 0;
        gbc.gridy = 0;
        jpSettingSubsf.add(jlRss, gbc);
